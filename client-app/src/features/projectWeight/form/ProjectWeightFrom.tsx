...
import {
  ProjectWeight,
  ProjectWeightFormValues,
} from "../../../app/models/projectWeight";
...
export default observer(function ProjectWeightForm() {
  ...
  function handleFormSubmit(projectWeight: ProjectWeightFormValues) {
    if (!projectWeight.projectWeightId) {
      let newProjectWeight: ProjectWeight = {
        ...projectWeight,
  ...
  if (loadingInitial)
    return <LoadingComponent content="Loading project weight..." />;
      ...
      >
        {({ handleSubmit, isValid, isSubmitting, dirty }) => (
          <Form className="ui form" onSubmit={handleSubmit} autoComplete="off">
            ...
            <MyTextInput
              placeholder="Peso de vendas"
              name="salesValueWeight"
              label="Peso vendas"
            />
            <MyTextInput
              placeholder="Peso de conversão"
              name="conversionWeight"
              label="Peso convesão"
            />
            <MyTextInput
              placeholder="Peso de cadastro"
              name="registrationWeight"
              label="Peso Cadastro"
            />
            <MyTextInput
              placeholder="Peso de Deposito"
              name="depositWeight"
              label="Peso deposito"
            />
            <Button
